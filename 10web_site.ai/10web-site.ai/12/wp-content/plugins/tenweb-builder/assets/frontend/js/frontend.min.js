...
var tenwebCountdown = function(e, t) {
    var i, n = {
        ...
        s = function() {
            ...
            })), s.total <= 0) && ("yes" == e.data("hide-after-expiry") && (e.find(".tenweb-countdown-item").addClass("tenweb-hidden"), e.parent().find(".tenweb-countdown-description").addClass("tenweb-hidden"), e.parent().find(".tenweb-countdown-expired").removeClass("tenweb-hidden")), clearInterval(i))
        };
...
tenwebCountdown.getTimeRemaining = function(e, t) {
        var i = new Date,
            ...
            o = t && s > 31 ? 12 * (e.getFullYear() - i.getFullYear()) + e.getMonth() - i.getMonth() : 0;
        t && o && (s = e.getDate() - i.getDate());
        var r = Math.floor(n / 36e5 % 24),
            a = Math.floor(n / 1e3 / 60 % 60),
            l = Math.floor(n / 1e3 % 60);
        return (s < 0 || r < 0 || a < 0) && (l = a = r = s = 0), {
            total: n,
            parts: {
                months: o,
                days: s,
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            onHotspotTriggerEvent: function(e) {
                ...
                if (!(t.closest(".e-hotspot--link").length && s && ("mouseleave" === e.type || "mouseenter" === e.type)) && (i || n)) {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            hideWord: function(e) {
                ...
                if ("typing" === o) t.elements.$dynamicWrapper.addClass(n.typeSelected), setTimeout((function() {
                    ...
                    t.hideLetter(e.find(s).eq(0), e, a, i.lettersDelay), t.showLetter(r.find(s).eq(0), r, a, i.lettersDelay)
                    ...
                    ["mousemove", function(e) {
                        ...
                        if (n) {
                            var s = Math.abs(n.x - t.x),
                                o = Math.abs(n.y - t.y);
                            if ((s > 0 || o > 0) && s <= 2 && o <= 2 && t.timeStamp - n.timeStamp <= 300 && (mouse = !0, i)) {
            ...
            prototype: {
                    ...
                    if (this.$firstSub = this.$root.find("ul").each((function() {
                        ...
                        this.$root.find("a").each((function() {
                            var e = this.href.replace(n, ""),
                                i = $(this);
                            e != s && e != o || (i.addClass("current"), t.opts.markCurrentTree && i.parentsUntil("[data-smartmenus-id]", "ul").each((function() {
                ...
                itemClick: function(e) {
                    ...
                    if (this.handleItemEvents(t)) {
                        ...
                        if (n && !n.is(":visible")) {
                            if (this.opts.showOnClick && s && (this.clickActivated = !0), this.itemActivate(t), n.is(":visible")) return this.focusActivated = !0, !1
                ...
                menuPosition: function(e) {
                    var t, i, n = e.dataSM("parent-a"),
                        ...
                        y = this.opts.rightToLeftSubMenus && !s.is("[data-sm-reverse]") || !this.opts.rightToLeftSubMenus && s.is("[data-sm-reverse]"),
                ...
                menuScroll: function(e, t, i) {
                    ...
                    if (!t && s.momentum) {
                        if (s.momentum *= .92, (n = s.momentum) < .5) return void this.menuScrollStop(e)
                    } else n = i || (t || !this.opts.scrollAccelerate ? this.opts.scrollStep : Math.floor(s.step));
                    var a = e.dataSM("level");
                    if (this.activatedItems[a - 1] && this.activatedItems[a - 1].dataSM("sub") && this.activatedItems[a - 1].dataSM("sub").is(":visible") && this.menuHideSubMenus(a - 1), s.y = s.up && r <= s.y || !s.up && r >= s.y ? s.y : Math.abs(r - s.y) > n ? s.y + (s.up ? n : -n) : r, e.add(e.dataSM("ie-shim")).css(this.cssTransforms3d ? {
                            "-webkit-transform": "translate3d(0, " + s.y + "px, 0)",
                            transform: "translate3d(0, " + s.y + "px, 0)"
                        } : {
                            marginTop: s.y
                        }), mouse && (s.up && s.y > s.downEnd || !s.up && s.y < s.upEnd) && o.eq(s.up ? 1 : 0).show(), s.y == r) mouse && o.eq(s.up ? 0 : 1).hide(), this.menuScrollStop(e);
                    else if (!t) {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            onInit: function() {
                jQuery("body").hasClass("elementor-editor-active") && (jQuery(".ai-recreated-menu-item").parent().css("gap", "3px"), jQuery(".ai-recreated-menu-item").each((function() {
                    ...
                    let t, i, n, s, o, r, a, l;
                    t = jQuery(this).closest("ul").attr("class"), i = jQuery(this).closest("li").attr("class"), n = new RegExp("twbb-menu_term_id-\\s*(\\d+)"), s = new RegExp("menu-item-\\s*(\\d+)"), o = new RegExp("twbb_menu_order_\\s*(\\d+)"), r = t.match(n), a = i.match(s), l = i.match(o), r && a && l && window.open(twbb.tenweb_dashboard + "/websites/" + twbb.dashboard_website_id + "/ai-builder?add_page=1&menu_term_id=" + r[1] + "&menu_item_id=" + a[1] + "&menu_item_position=" + l[1], "_blank")
    ...
    twbb_posts = function(e, t) {
        ...
        this.query_args = e.query_args, this.query_args_hash = e.query_args_hash, this.widget_id = e.widget_id, this.settings = e.settings, this.posts = [], this.pages_count = 1, this.init = function() {
            ...
            function() {
                ...
                "above_title" === settings.image_position ? s += e + t : s += t + e;
                if (void 0 !== settings.meta_data && settings.meta_data.length > 0) {
                    ...
                    for (var n = 0; n < settings.meta_data.length; n++) {
                        switch (settings.meta_data[n]) {
                            case "author":
                                s += '<span class="twbb-posts-author-meta"><% print(posts_print_author(twbb_author)) %></span>';
                                break;
                            case "date":
                                s += '<span class="twbb-posts-date-meta"><%= twbb_date %></span>';
                                break;
                            case "time":
                                s += '<span class="twbb-posts-time-meta"><%= twbb_time %></span>';
                                break;
                            case "comments":
                                s += '<span class="twbb-posts-comments-meta"><% if(twbb_comments > 0) { %><%=  twbb_comments %> <% }else{ print("No") } print(" comments")%></span>';
                                break;
                            case "categories":
                                s += '<span class="twbb-posts-categories-meta"><% print(posts_print_terms(twbb_categories, "categories")) %></span>';
                                break;
                            case "tags":
                                s += '<span class="twbb-posts-tags-meta"><% print(posts_print_terms(twbb_tags, "tags")) %></span>'
                        }
                        s += '<span class="twbb-posts-meta-separator">' + settings.meta_separator + "</span>"
                    }
                    s += "</div>"
                }
                "yes" === settings.show_excerpt && (s += "<div class='twbb-posts-content'><%= twbb_excerpt %></div>");
                "yes" === settings.show_read_more && (s += "<div class='twbb-posts-read-more'><a href='<%= twbb_permalink %>'>" + settings.read_more_text + "</a></div>");
            ...
            if (this.show_loading(), 1 === n && void 0 !== e.first_page_data) return i.posts = e.first_page_data.posts, i.pages_count = e.first_page_data.pages_count, i.render(), void i.hide_loading();
            ...
            if ("yes" === this.settings.pagination_number_buttons)
                for (var d = 1; d <= l; d++) s = "twbb-posts-page twbb-posts-page-num", d === n && (s += " twbb-posts-current-page " + t), e += get_page_link_html(s, d, d);
            "yes" === this.settings.pagination_next_prev_buttons && (s = "twbb-posts-page twbb-posts-page-next", n === this.pages_count && (s += " " + t), e += get_page_link_html(s, n + 1, this.settings.pagination_next_label)), "yes" === this.settings.pagination_first_last_buttons && (s = "twbb-posts-page twbb-posts-page-last", n === this.pages_count && (s += " " + t), e += get_page_link_html(s, l, this.settings.pagination_last_label)), null === r ? (e = "yes" === this.settings.pagination_scroll_top ? "<div class='twbb-posts-pagination twbb-pagination_scroll_top'>" + e + "</div>" : "<div class='twbb-posts-pagination'>" + e + "</div>", a.parent().append(e), r = o.find(".twbb-posts-pagination")) : r.append(e), r.find(".twbb-posts-page").on("click", (function(e) {
                ...
                return t < 1 || t > i.pages_count || (n = t, i.get_posts(), jQuery(this).parent().hasClass("twbb-pagination_scroll_top") && jQuery(window).scrollTop(0)), !1
            }))
            ...
            for (var r in e) n += !0 === o ? "<a href='" + e[r].link + "'>" + s + e[r].name + "</a>, " : s + e[r].name + ", ";
...
jQuery(window).on("elementor/frontend/init", (function() {
    ...
    function(e) {
        var t = function(i, n) {
            var s, o = {},
                r = function(e) {
                    ...
                    if (o.width && o.height) {
                        ...
                        i = "toolbar=0,status=0,width=" + o.width + ",height=" + o.height + ",top=" + s + ",left=" + n
                    }
                    var r = function(e) {
                            var i = t.networkTemplates[e].replace(/{([^}]+)}/g, (function(t, i) {
                                if ("twitter" == e && "text" == i) {
                                    var n = jQuery(jQuery.parseHTML(o[i])).text().replace(/\s\s+/g, " "),
            ...
            e.extend(o, t.defaultSettings, n), ["title", "text"].forEach((function(e) {
                o[e] = o[e].replace("#", "")
            })), o.classPrefixLength = o.classPrefix.length, s = e(i), a()
        };
        t.networkTemplates = {
        ...
        e = t.extend({
            onInit: function() {
                ...
                n ? s.url = e.share_url.url : (s.url = location.href, s.title = elementorFrontend.config.post.title, s.text = elementorFrontend.config.post.excerpt), this.elements.$shareButton.shareLink(s)
            },
            getDefaultSettings: function() {
                return {
                    selectors: {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            followAnchor: function(e, t) {
                ...
                elementorFrontend.waypoint(i, (function(s) {
                    if (!n.itemClicked) {
                        var o = i.attr("id");
                        "down" === s ? (n.viewportItems[o] = !0, n.activateItem(e)) : (delete n.viewportItems[o], n.activateItem(n.$listItemTexts.eq(t - 1)))
                    }
                }), {
                    ...
                    if (!n.itemClicked) {
                        var o = i.attr("id");
                        "down" === s ? (delete n.viewportItems[o], n.viewportItems.length && n.activateItem(n.$listItemTexts.eq(t + 1))) : (n.viewportItems[o] = !0, n.activateItem(e))
                    }
                }), {
                    offset: 0,
                    triggerOnce: !1
            ...
            getNestedLevel: function(e) {
                for (var t = this.getSettings(), i = this.getElementSettings(), n = this.getElementSettings("icon"), s = "<".concat(t.listWrapperTag, ' class="').concat(t.classes.listWrapper, '">'); this.listItemPointer < this.headingsData.length;) {
                    ...
                    if (e === o.level) {
                        ...
                        "bullets" === i.marker_view && n && (a = '<i class="'.concat(n.value, '"></i>').concat(a)), s += a, s += "</div>", this.listItemPointer++;
            ...
            getHeadingAnchorLink: function(e, t) {
                var i = this.elements.$headings[e].id,
                    ...
                    s = "";
                return i ? s = i : n && (s = n), i || n ? jQuery(this.elements.$headings[e]).data("hasOwnID", !0) : s = "".concat(t.headingAnchor, "-").concat(e), s
            },
            ...
            onListItemClick: function(e) {
                ...
                var i, n = jQuery(e.target),
                    s = n.parent().next(),
                    o = this.getElementSettings("collapse_subitems");
                o && n.hasClass(this.getSettings("classes.firstLevelListItem")) && s.is(":visible") && (i = !0), this.activateItem(n), o && i && s.slideUp()
            }
        });
...
class TWBB_WooCommerce_Base extends elementorModules.frontend.handlers.Base {
    ...
    activateStickyRightColumn() {
        ...
        t.length && "fixed" === t.css("position") && (n += t.height()), "yes" === this.getElementSettings("sticky_right_column") && (this.elements.$stickyRightColumn.addClass(i.stickyRightColumnActive), this.elements.$stickyRightColumn.css("top", n + "px"))
    }
    ...
    function(e, t) {
        tenwebParallax = function(i, n) {
            ...
            ! function(e) {
                ...
                for (let e = 0; e < t.length; e++) "object" == typeof t[e] && "object" == typeof s[t[e][0]] && "object" == typeof t[e][1] && (void 0 !== t[e][1].active && ["on", "yes", "On", "Yes", !0].includes(t[e][1].active) && (o[t[e][0]].active = !0), void 0 !== t[e][1].speed && 0 <= t[e][1].speed <= 10 && (o[t[e][0]].speed = t[e][1].speed), void 0 !== t[e][1].direction && ["in", "out", "up", "down"].includes(t[e][1].direction) && (o[t[e][0]].direction = t[e][1].direction))
            }(n), this.layerDiv = function() {
                ...
                return s.style.backgroundImage = o.backgroundImage, s.style.backgroundPosition = o.backgroundPosition, s.style.backgroundRepeat = o.backgroundRepeat, s.style.backgroundSize = o.backgroundSize, n.appendChild(s), i.prepend(n), s
            }(), this.options = o
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            updateSettings: function(e) {
                var t = this;
                for (const [i, n] of Object.entries(t.defoult_settings)) void 0 !== e[i] ? t.current_settings[i] = e[i] : t.current_settings[i] = t.defoult_settings[i]
            },
...
var posts_base = elementorModules.frontend.handlers.Base.extend({
        ...
        fitImages() {
            var e = jQuery,
                ...
                n = this.getSettings();
            this.elements.$postsContainer.toggleClass(n.classes.hasItemRatio, !!i.match(/\d/)), t.isMasonryEnabled() || this.elements.$posts.each((function() {
                var i = e(this),
                    s = i.find(n.selectors.postThumbnailImage);
                t.fitImage(i), s.on("load", (function() {
                    t.fitImage(i)
                }))
            }))
        },
    ...
    portfolio = posts_base.extend({
        ...
        filterItems(e) {
            ...
            "__all" !== e ? (t.not(n).removeClass(i), t.filter(n).addClass(i)) : t.addClass(i)
        },
        ...
        handleEmptyColumns() {
            ...
            for (var e = this.getSettings(), t = this.elements.$posts.filter(":visible"), i = this.elements.$postsContainer.find("." + e.classes.ghostItem), n = (e.colsCount - (t.length + i.length) % e.colsCount) % e.colsCount, s = 0; s < n; s++) this.elements.$postsContainer.append(jQuery("<div>", {
        ...
        arrangeGrid() {
            ...
            c.css({
                ...
                n.start === s.start && n.top === s.top || (s.start -= n.start, s.top -= n.top, elementorFrontend.config.is_rtl && (s.start *= -1), i.css({
                    transitionDuration: "",
...
jQuery(window).on("elementor/frontend/init", (function() {
    ...
    updateSpaceBetween(e) {
        ...
        "desktop" !== i ? this.swiper.params.breakpoints[this.getDeviceBreakpointValue(i)].spaceBetween = n : this.swiper.params.spaceBetween = n, this.swiper.params.spaceBetween = n, this.swiper.update()
    }
    async onInit() {
    ...
    updateSwiperOption(e) {
        ...
        "pause_on_hover" !== e && (this.swiper.params[n] = s), this.swiper.update()
    }
    onElementChange(e) {
        if (1 >= this.getSlidesCount()) return;
...
jQuery(window).on("elementor/frontend/init", (function() {
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            async initSlider() {
                ...
                this.swipers.main = await new n(this.elements.$slider, this.getSwiperOptions()), this.editButtonChange(), i && (this.swipers.main.on("slideChangeTransitionStart", (function() {
            ...
            editButtonChange: function(e) {
                if (jQuery("body").hasClass("elementor-editor-active") && (elementor.getPanelView().getCurrentPageView().$el.find(".elementor-repeater-fields .elementor-edit-template").remove(), this.$element.find(".elementor-widget-container .elementor-swiper .twbb_slides-wrapper .swiper-wrapper .swiper-slide-template.swiper-slide-active").length)) {
                    var t = this.$element.find(".elementor-widget-container .elementor-swiper .twbb_slides-wrapper .swiper-wrapper .swiper-slide-template.swiper-slide-active").attr("data-template-id"),
                        ...
                        n = "Add";
                    t && (i = twbb.home_url + "/wp-admin/post.php?post=" + t + "&action=elementor", n = "Edit");
                    var s = jQuery("<a />", {
                        target: "_blank",
                    ...
                    elementor.getPanelView().getCurrentPageView().$el.find(".elementor-control-template_id").after(s)
                }
            },
            onInit: function() {
        ...
        var t = function(t, i) {
            ...
            const p = () => {
                if (r = v(n, "width"), o = n.offset().left, s.isRTL) {
                    const e = s.handleScrollbarWidth ? window.innerWidth : document.body.offsetWidth;
                    o = Math.max(e - r - o, 0)
                }
            };
            var g = function() {
                    d.$spacer = n.clone().addClass(s.classes.spacer).css({
                        visibility: "hidden",
                        transition: "none",
                        animation: "none"
                    }), n.after(d.$spacer)
                ...
                b = function() {
                    u(n, "unsticky", ["position", "width", "margin-top", "margin-bottom", "top", "bottom", "inset-inline-start"]);
                    const e = {
                        position: "fixed",
                        width: r,
                        marginTop: 0,
                    ...
                    e[s.to] = s.offset, e["top" === s.to ? "bottom" : "top"] = "", o && (e["inset-inline-start"] = o + "px"), n.css(e).addClass(s.classes.stickyActive)
                },
                w = function() {
                ...
                v = function(e, t, i) {
                    var n = getComputedStyle(e[0]),
                        ...
                        r = [];
                    return "border-box" !== n.boxSizing && r.push("border", "padding"), i && r.push("margin"), r.forEach((function(e) {
                ...
                S = function() {
                    var e = y(n),
                        t = "top" === s.to;
                    if (l) {
                        (t ? e.top.fromTop > s.offset : e.bottom.fromBottom < -s.offset) && (d.$parent.css(m(d.$parent, "childNotFollowing")), n.css(m(n, "notFollowing")), l = !1)
                    } else {
                        var i = y(d.$parent),
                        ...
                        (t ? h <= e.bottom.fromTop : h >= e.top.fromBottom) && function() {
                            u(d.$parent, "childNotFollowing", ["position"]), d.$parent.css("position", "relative"), u(n, "notFollowing", ["position", "inset-inline-start", "top", "bottom"]);
                            const e = {
                                position: "absolute"
                            };
                            ...
                            e["inset-inline-start"] = o + "px", e[s.to] = "", e["top" === s.to ? "bottom" : "top"] = 0, n.css(e), l = !0
                        }()
                    }
                },
                $ = function() {
                    ...
                    if (a) {
                        var i = y(d.$spacer);
                        e = "top" === s.to ? i.top.fromTop - t : -i.bottom.fromBottom - t, s.parent && S(), e > 0 && _()
                    } else {
                        var o = y(n);
                        (e = "top" === s.to ? o.top.fromTop - t : -o.bottom.fromBottom - t) <= 0 && (p(), g(), b(), a = !0, n.trigger("sticky:stick"), s.parent && S())
                    }! function(e) {
                        c && -e < s.effectsOffset ? (n.removeClass(s.classes.stickyEffects), c = !1) : !c && -e >= s.effectsOffset && (n.addClass(s.classes.stickyEffects), c = !0)
                    }(e)
                },
                C = function() {
                    $()
            ...
            this.destroy = function() {
                a && _(), d.$window.off("scroll", C).off("resize", k), n.removeClass(s.classes.sticky)
            }, s = jQuery.extend(!0, h, i), n = e(t).addClass(s.classes.sticky), d.$window = e(window), s.parent && (d.$parent = n.parent(), "parent" !== s.parent && (d.$parent = d.$parent.closest(s.parent))), d.$window.on({
                scroll: C,
                resize: k
            }), $()
        };
        e.fn.sticky = function(i) {
            ...
            return this.each((function() {
                ...
                if (n) {
                    ...
                    o[i].apply(o, Array.prototype.slice.call(arguments, 1)), "destroy" === i && s.removeData("sticky")
    ...
    function(e) {
        var t = function(t, i) {
            ...
            var p = function() {
                ...
                f = function() {
                    h(n, "unsticky", ["position", "width", "margin-top", "margin-bottom", "top", "bottom", "inset-inline-start"]);
                    const e = {
                        position: "fixed",
                        width: r,
                        marginTop: 0,
                ...
                _ = function() {
                    var e = v(n),
                        t = "top" === s.to;
                    if (l)(t ? e.top.fromTop > s.offset : e.bottom.fromBottom < -s.offset) && (d.$parent.css(u(d.$parent, "childNotFollowing")), n.css(u(n, "notFollowing")), l = !1);
                    else {
                        var i = v(d.$parent),
                            a = getComputedStyle(d.$parent[0]),
                            c = parseFloat(a[t ? "borderBottomWidth" : "borderTopWidth"]),
                        ...
                        (t ? m <= e.bottom.fromTop : m >= e.top.fromBottom) && function() {
                            h(d.$parent, "childNotFollowing", ["position"]), d.$parent.css("position", "relative"), h(n, "notFollowing", ["position", "inset-inline-start", "top", "bottom"]);
                            const e = {
                                position: "absolute"
                            };
                            if (o = d.$spacer.position().left, s.isRTL) {
                ...
                S = function() {
                    ...
                    if (a) {
                        var i = v(d.$spacer);
                        e = "top" === s.to ? i.top.fromTop - t : -i.bottom.fromBottom - t, s.parent && _(), e > 0 && y()
                    } else {
                        var o = v(n);
                        (e = "top" === s.to ? o.top.fromTop - t : -o.bottom.fromBottom - t) <= 0 && (m(), p(), f(), a = !0, n.trigger("sticky:stick"), s.parent && _())
                    }! function(e) {
                        c && -e < s.effectsOffset ? (n.removeClass(s.classes.stickyEffects), c = !1) : !c && -e >= s.effectsOffset && (n.addClass(s.classes.stickyEffects), c = !0)
                    }(e)
                },
            ...
            this.destroy = function() {
                a && y(), d.$window.off("scroll", $).off("resize", C), n.removeClass(s.classes.sticky)
            }, s = jQuery.extend(!0, {
                to: "top",
                offset: 0,
                effectsOffset: 0,
                ...
                isRTL: !1,
                handleScrollbarWidth: !1
            }, i), n = e(t).addClass(s.classes.sticky), d.$window = e(window), s.parent && (d.$parent = n.parent(), "parent" !== s.parent && (d.$parent = d.$parent.closest(s.parent))), d.$window.on({
                scroll: $,
                resize: C
            }), S()
        };
        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            getConfig: function() {
                ...
                return i.length && "top" === e.tenweb_sticky && "fixed" === i.css("position") && (t.offset += i.height()), e.tenweb_sticky_parent && !n && (t.parent = ".e-container, .e-container__inner, .e-con, .e-con-inner, .elementor-widget-wrap"), t
            },
            activate: function() {
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/twbb-testimonial-carousel.default", (function() {
            jQuery(".tenweb-testimonial-carousel-swiper").each((async function(s, o) {
...
var _baseTabs = class extends elementorModules.frontend.handlers.Base {
        ...
        activateDefaultTab(e) {
            ...
            this.setSettings({
                showTabFn: "show",
                hideTabFn: "hide"
            }), this.changeActiveTab(i), this.setSettings(n)
        }
        ...
        activateTab(e) {
            ...
            n.add(s).addClass(i), n.attr({
                tabindex: "0",
                "aria-selected": "true"
            }), s[t.showTabFn](o, (() => elementorFrontend.elements.$window.trigger("resize"))), s.removeAttr("hidden")
        }
        isActiveTab(e) {
    ...
    _playerBase = class {
        ...
        formatDuration(e) {
            const t = new Date(1e3 * e),
                ...
                n = t.getUTCMinutes(),
                s = t.getSeconds();
            return 0 !== i ? `${i.toString()}:${n.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}` : `${n.toString()}:${s.toString().padStart(2,"0")}`
        }
    },
    ...
    _playerHosted = class extends _playerBase {
        ...
        create() {
            return new Promise((e => {
                ...
                n.setAttribute("src", this.playlistItem.videoUrl), n.setAttribute("type", "video/" + this.playlistItem.videoUrl.split(".").pop()), t.appendChild(n), t.appendChild(i), this.playerObject = t, this.playlistItem.tabContent.querySelector("div").replaceWith(this.playerObject), this.playerObject.addEventListener("canplay", (() => {
                    this.isReady = !0, e()
    ...
    _urlParams = {
        ...
        setVideoParams(e, t, i) {
            ...
            n.set("playlist", e), n.set("video", t[i - 1].dataItemId), history.replaceState({}, "", location.pathname + "?" + n)
        }
    },
    VideoPlaylistHandler = class extends _baseTabs {
        ...
        createPlaylistItems() {
            this.playlistItemsArray = [], this.elements.$videos.each(((e, t) => {
                const i = {},
                    n = jQuery(t);
                i.videoUrl = n.attr("data-video-url"), i.videoType = n.attr("data-video-type"), i.videoTitle = n.attr("data-video-title"), i.videoDuration = n.attr("data-video-duration"), i.tabContent = t, i.dataTab = e + 1, i.dataItemId = this.getElementSettings().tabs[e]._id, this.playlistItemsArray.push(i)
...
jQuery(window).on("elementor/frontend/init", (function() {
        ...
        class e extends elementorModules.frontend.handlers.Base {
            ...
            bindEvents() {
                ...
                if (n && s) return void this.$element.find(o.toggleButton).attr("href", i);
        ...
        class e extends TWBB_WooCommerce_Base {
            ...
            editorInitTabs() {
                this.elements.$allPageElements.each(((e, t) => {
                    ...
                    let n;
                    if ("view-order" === i) n = this.elements.$viewOrderLinks.add(this.elements.$viewOrderButtons);
                    else n = this.$element.find(".woocommerce-MyAccount-navigation-link--" + i);
                    n.on("click", (() => {
    ...
    function() {
        this.MultiRange = function(e, t) {
            ...
            getRangesHTML() {
                var e, t = this,
                    i = "";
                return this.ranges.unshift(0), this.ranges[this.ranges.length - 1] <= this.settings.max && this.ranges.push(this.settings.max), (e = this.ranges).forEach((function(n, s) {
                    if (s != e.length - 1) {
                        var o = (n - t.settings.min) / t.delta * 100;
                        o < 0 && (o = 0), i += '<div data-idx="' + s + '" class="multiRange__range" style="left:' + o + '%"><div class="multiRange__handle"></div></div>', 1 == s ? jQuery(".current_min_price").html(n.toFixed(1).replace(".0", "")) : 2 == s && jQuery(".current_max_price").html(n.toFixed(1).replace(".0", ""))
                    }
                })), i
            },
            ...
            events: {
                ...
                callbacks: {
                    ...
                    onMouseMove: function(e) {
                        ...
                        var t, i = this,
                            n = (e.touches ? e.touches[0].clientX - this.offsetLeft : e.clientX - this.offsetLeft) / this.scopeWidth * 100,
                            s = this.ranges[+this.DOM.currentSlice.dataset.idx - 1],
                            o = this.ranges[+this.DOM.currentSlice.dataset.idx + 1];
                        t = this.settings.min + this.delta / 100 * n, this.settings.step && (t = Math.round(t / this.settings.step) * this.settings.step), t < s + this.settings.minRange && (t = s + this.settings.minRange), t > o - this.settings.minRange && (t = o - this.settings.minRange), t < this.settings.min + this.settings.minRange && (t = this.settings.min + this.settings.minRange), t > this.settings.max - this.settings.minRange && (t = this.settings.max - this.settings.minRange), n = (t - this.settings.min) / this.delta * 100, window.requestAnimationFrame((function() {
                            i.DOM.currentSlice && (i.DOM.currentSlice.style.left = n + "%")
...
jQuery(".twbb_woo_price_filter").submit((function(e) {
    ...
    class e extends TWBB_WooCommerce_Base {
        ...
        bindEvents() {
            ...
            })), elementorFrontend.elements.$body.off("added_to_cart.twbb_woocommerce-product-add-to-cart"), elementorFrontend.elements.$body.on("added_to_cart.twbb_woocommerce-product-add-to-cart", ((e, t, i, n) => {
    ...
    jQuery.ajax({
        ...
        success: function(e) {
            const t = (new DOMParser).parseFromString(e, "text/html"),
                s = jQuery(t).find('.elementor-widget-twbb_woocommerce-products[data-id="' + n + '"]').html();
            i.html(s), jQuery(".twbb_woocommerce-products-ajax-paginate .page-numbers li").on("click", (function(e) {
